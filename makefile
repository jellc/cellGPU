...
#INCLUDES += -I/home/ubuntu_setup/cellgpu/CGAL-4.9/include/CGAL
LIB_CUDA = -L. -L$(CUDA_LIB) -L$(CUDA_LIB2) -lcuda -lcudart
LIB_CGAL += -L/usr/local/lib/CGALCellar/cgal/4.9/lib -L/usr/local/Cellar/gmp/6.1.2/lib -L/usr/local/Cellar/mpfr/3.1.5/lib
LIB_CGAL += -L/home/ubuntu_setup/cellgpu/CGAL-4.9/lib -lCGAL -lCGAL_Core -lgmp -lmpfr
